...
public class SubjectController {
    ...
    @PostMapping("getStudentsId")
    public static ResponseEntity<Object> getStudentsId(@RequestBody Subject subject){
        Map<String, Object> response = new HashMap<>();
        response.put("ok", true);
        response.put("studentsId", subject.getStudentsId());
        return ResponseEntity.ok().body(response);
    }

    @PostMapping("getTeacherId")
    public static ResponseEntity<Object> getTeacherId(@RequestBody Subject subject){
        Map<String, Object> response = new HashMap<>();
        response.put("ok", true);
        response.put("teacherId", subject.getTeacherId());
        return ResponseEntity.ok().body(response);
    }

    @PostMapping("getDescription")
    public static ResponseEntity<Object> getDescription(@RequestBody Subject subject){
        Map<String, Object> response = new HashMap<>();
        response.put("ok", true);
    ...
    public static ResponseEntity<Object> getTitle(@RequestBody Subject subject){
        Map<String, Object> response = new HashMap<>();
        response.put("ok", true);
